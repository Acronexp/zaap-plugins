...
class Useful(commands.Cog):
    ...
    def wiki(self, recherche: str, langue: str = 'fr', souple: bool = True):
        ...
        try:
            ...
            if r:
                ...
                images = page.images
                image = [i for i in images if i.endswith(".png") or i.endswith(".gif") or i.endswith(".jpg") or i.endswith(".jpeg")][0]
                resum = page.summary
                if not resum:
    ...
    def watermark_with_transparency(self, input_image_path, output_image_path, watermark_image_path, position):
        ...
        watermark.thumbnail((width / 9, height / 9))
    ...
    async def aptwatermark(self, ctx, url=None):
        ...
        async with ctx.channel.typing():
            ...
            filepath = await self.download(url[0])
            result = self.watermark_with_transparency(filepath, filepath, apt, (5, 5))
